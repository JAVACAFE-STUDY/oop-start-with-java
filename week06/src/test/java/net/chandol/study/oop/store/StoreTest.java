...
public class StoreTest {
    ...
    public void 주문생성_테스트(){
        ...
        // 사용자에게 주문을 추가합니다.
        Order order = orderRepository.save(new Order(member1, new Date(), OrderStatus.ORDER));
        OrderItem orderItem1 = orderItemRepository.save(new OrderItem(item1, order, 4000, 3));
        OrderItem orderItem2 = orderItemRepository.save(new OrderItem(item2, order, 1000, 2));
